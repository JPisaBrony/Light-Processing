...
public class EntityMoveBlock extends Entity {
    public int blockID;
    public int metadata;
    ...
    public EntityMoveBlock(World par1World)
    {
        super(par1World);
    ...
    public EntityMoveBlock(World par1World, double par2, double par4, double par6, int par8)
    {
        this(par1World, par2, par4, par6, par8, 0);
    }

    public EntityMoveBlock(World par1World, double par2, double par4, double par6, int par8, int par9)
    {
        super(par1World);
        this.shouldDropItem = true;
        this.fallHurtMax = 40;
