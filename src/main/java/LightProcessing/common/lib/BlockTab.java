...
public class BlockTab extends CreativeTabs {
	...
	public ItemStack getIconItemStack() {
		return new ItemStack(LightProcessing.common.lib.LPBlocks.BlockAbsBlock);
	}

	public static void InitTab() {
		blockTab = new BlockTab("blockTab");
		LanguageRegistry.instance().addStringLocalization("itemGroup.blockTab", "en_US", "Light Processing Blocks");
	}
