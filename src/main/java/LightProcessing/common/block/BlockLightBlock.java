...
public class BlockLightBlock extends Block {
	...
	public BlockLightBlock(Material material) {
		super(material);
		this.setLightLevel(1.0F);
		this.setHardness(10);
		this.setResistance(500000);
		this.setCreativeTab(LightProcessing.common.lib.BlockTab.blockTab);
		this.setBlockName("LightBlock");
	}

	@Override
	public void setBlockBoundsBasedOnState(IBlockAccess par1IBlockAccess, int par2, int par3, int par4) {
		if (!par1IBlockAccess.isAirBlock(par2, par3 - 1, par4) && par1IBlockAccess.getBlock(par2, par3 - 1, par4) != LPBlocks.BlockLightBlock) {
	...
	public int onBlockPlaced(World par1World, int par2, int par3, int par4, int par5, float par6, float par7, float par8, int par9) {
		if (par1World.getBlock(par2, par3 - 1, par4) == Blocks.dirt) {
			par1World.setBlock(par2, par3 - 1, par4, Blocks.grass);
		}
	...
	public boolean shouldSideBeRendered(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5) {
		...
		if (par1IBlockAccess.getBlock(par2, par3, par4) == LPBlocks.BlockLightBlock) {
			return false;
		}
		if (par1IBlockAccess.isSideSolid(par2, par3, par4, ForgeDirection.UP, true)) {
			return true;
		}
		if (par5 == 0 && par1IBlockAccess.getBlock(par2, par3, par4) != LPBlocks.BlockLightBlock) {
			return true;
		}
		return false;
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity) {
		...
		if (par1World.getBlockMetadata(par2, par3, par4) > 0) {
			...
			boolean xpos = (par1World.isSideSolid(par2 + 1, par3, par4, ForgeDirection.UP));
			boolean xneg = (par1World.isSideSolid(par2 - 1, par3, par4, ForgeDirection.UP));
			boolean zpos = (par1World.isSideSolid(par2, par3, par4 + 1, ForgeDirection.UP));
			boolean zneg = (par1World.isSideSolid(par2, par3, par4 - 1, ForgeDirection.UP));
			double speed = 0.2;
			double cSpeed = 0.25;
