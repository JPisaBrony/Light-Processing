...
public class ClientProxy extends CommonProxy {
	...
	public void registerRenderThings() {
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityExtractinator.class, new TileEntityExtractinatorRender());
		MinecraftForgeClient.registerItemRenderer(IDRef.Extractinator_ID, new ItemExtractinatorRenderer());
	}
