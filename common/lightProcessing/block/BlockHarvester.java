...
public class BlockHarvester extends BlockContainer {
	...
	public void registerIcons(IconRegister IconRegister) {
		this.blockIcon = IconRegister.registerIcon(Methods.textureName(this
				.getUnlocalizedName()));
	}
	...
	public void randomDisplayTick(World world, int x, int y, int z,
		...
		world.spawnParticle("portal", (double) f1 + f4, (double) f2,
		...
		world.spawnParticle("portal", (double) f1 + f4, (double) f2,
				(double) f3 + f5, 0.0D, 0.0D, 0.0D);
		world.spawnParticle("instantSpell", (double) f1 + f4, (double) f2,
				(double) f3 + f5, 0.0D, 0.0D, 0.0D);
