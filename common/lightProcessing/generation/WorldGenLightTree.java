package LightProcessing.common.lightProcessing.generation;
            ...
            else
            {
                ...
                if (isSoil && par4 < 256 - l - 1)
                {
                    ...
                    for (j1 = 0; j1 < l; ++j1)
                    {
                        ...
                        if (block == null || block.isAirBlock(par1World, par3, par4 + j1, par5) || k1 == IDRef.DARK_LEAF_ID)
                        {
