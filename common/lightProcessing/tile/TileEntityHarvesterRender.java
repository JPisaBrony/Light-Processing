...
import LightProcessing.resources.ltp.models.ModelHarvester;
...
public class TileEntityHarvesterRender extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(Harvester);
