...
import LightProcessing.common.render.ModelCompressor;
...
public class TileEntityMachineCoreRender extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(MachineCore);
		...
		// Tell it to stop rendering for both the PushMatrix'sz
		GL11.glPopMatrix();
		GL11.glPopMatrix();
	}
