...
public class BlockStabilizer extends Block {
	...
	public BlockStabilizer(int par1, Material par2Material) {
		super(par1, par2Material);
		this.setHardness(10);
		this.setCreativeTab(BlockTab.blockTab);
		this.setUnlocalizedName("Stabilizer");
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack) {
		...
		TileEntityStabilizer tile = (TileEntityStabilizer) world.getBlockTileEntity(x, y, z);
		if (!world.isRemote) {
